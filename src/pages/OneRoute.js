...
const classes={
  ...
  hearticon:'mr-6 phone:mr-27',
  staricon:'mr-6 phone:mr-28',
  ...
  spanlike:'lg:mr-14 text-center content-center phone:mr-2 phone:text-sm',
  spanquali:'lg:mr-2 text-center content-center phone:mr-10 phone:text-sm',
  liketext:'mr-15',
  qualitext:'mr-29',
  datecon:'"m-1 px-6',
