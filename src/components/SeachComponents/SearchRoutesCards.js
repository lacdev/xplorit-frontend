...
const classes={
    ...
    numbertextcon:'py-3',
    numbertext:'text-xs break-words decoration-solid ',
    btn:'py-1',
    iconcon:'ml-auto',
    starticon:'mt-5',
    starttext:'text-xs text-center aling-center ml-2',   
 }
function SearchRoutesCards({id, name, score, labels, images=[],  type, number}) {
    ...
    <Link to={cardLink}>
      ...
      <div className={classes.detailscon}>
        ...
        <div className={classes.numbertextcon}>
          <p className={classes.numbertext}>{number} Lugares en total</p>
        </div>
        <div>
          <Link to={cardLink}>
            <Btncards
...
export default SearchRoutesCards